                ...
                <div class="logo-2">
                  <a href="{{route('home')}}" class="clearfix">
					...
					<div class="main-menu-container">
                      ...
                      <!-- MENU ITEM -->
                      <li>
                        <a href="{{route('howitworks')}}"><div class="main-menu-title">HOW IT WORK</div></a>
                      </li>
				...
				<div class="relative">
								...
								<li data-transition="zoomout" data-slotamount="1" data-saveperformance="on" data-masterspeed="1500">
									...
									<div class="rs-parallaxlevel-4  opacity-scroll2">					
										...
										<div class="tp-caption font-white light-72-wide sfb tp-resizeme"
											...
											style="z-index: 7; max-width: auto; max-height: auto; white-space: nowrap;">WELCOME TO <span class="bold" style="color:#0088cc;">ViC</span>
										</div>
                  ...
                  <img src="images/revo-slider/dummy.png"  alt="slidebg2" data-lazyload="images/revo-slider/index.png" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
                      ...
                      data-voffset="87" 
											...
											data-elementdelay="0.1"
											data-endelementdelay="0.1"
											style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><span class="bold" style="">GREAT IDEAS</span>
										</div>
                  ...
                  <!-- MAIN IMAGE -->
                      ...
                      data-voffset="87" 
											...
											data-elementdelay="0.1"
											data-endelementdelay="0.1"
											style="z-index: 9; max-width: auto; max-height: auto; white-space: nowrap;"><span class="bold" style="">PRODUCTIZE!</span>
										</div>
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="row client-row border-bot">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/aalborg- university-logo.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/technical- university- sofia-logo.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/athens-Institute-of-technology-logo.gif">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/UNESCO-logo.png">
                    </div>
                ...
                <div class="row client-row">
                    ...
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/university-of-rome-tor-vergata-logo.jpg">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/ural-federal-university-logo.jpg">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/stevens-institute-of-technology-logo.png">
                    </div>
                  
                    <div class="col-xs-6 col-sm-3 text-center">
                      <img alt="client" src="images/clients/university-of-arkansas-logo.jpg">
                    </div>
              ...
              <div class="col-md-5">
                <blockquote class="quote mb-0 pl-50-min-1169">
                  <p>We're not the only ones happy & excited about your idea... </p>
                  <p style="color:#0088cc;">25+ incubation centers in 10 countries partner with us. Meet our partners.</p>
                 </blockquote>
							</div>
