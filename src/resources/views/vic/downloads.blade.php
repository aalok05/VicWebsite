...
<br>
	  ...
	  <div class="page-section p-110-cont">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="mb-50">
								  <h2 class="section-title"><span class="bold">DOWNLOADS</span></h2>
								</div>
							</div>
                            ...
                            <div class="post-prev-title">
                                <h3>Deveopment Flow pdf</h3>
                            </div>
                            <a class="button medium blue" href="download/DevelopmentFlow.pdf" download>DOWNLOAD</a>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70" data-wow-delay="200ms">
                            ...
                            <a class="button medium blue" href="download/vic.pptx" download>DOWNLLOAD</a>

                        </div>
						  <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70">

                            <div class="post-prev-title">
                                <h3>Incubation pdf</h3>
                            </div>
                            <a class="button medium blue" href="download/incubation.pdf" download>DOWNLOAD</a>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 wow fadeIn pb-70" data-wow-delay="200ms">
                            ...
                            <div class="post-prev-title">
                                <h3>About Vimeet ppt</h3>
                            </div>
                            <a class="button medium blue" href="download/vimeet.pptx" download>DOWNLLOAD</a>
